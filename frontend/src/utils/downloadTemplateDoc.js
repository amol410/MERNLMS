    ...
    sections: [
      {
        children: [
          ...
          heading('— Match the Pairs Question Example —'),
          comment('Add MATCH_PAIRS on its own line after Q:, then define 4 LEFT and RIGHT pairs.'),
          p('Q: Match the following Python data structures with their characteristics:'),
          p('MATCH_PAIRS'),
          p('LEFT_1: list'),
          p('RIGHT_1: Ordered, mutable sequence of items'),
          p('LEFT_2: tuple'),
          p('RIGHT_2: Ordered, immutable sequence of items'),
          p('LEFT_3: set'),
          p('RIGHT_3: Unordered collection of unique elements'),
          p('LEFT_4: dict'),
          p('RIGHT_4: Key-value pair collection'),
          p('EXPLANATION: Lists are mutable, tuples are immutable, sets store unique items, dicts store key-value pairs.'),
          p('POINTS: 2'),
          blank(),

          heading('— Add More Questions Below —'),
          comment('Copy any question block above (MCQ, True/False, or Match Pairs) and paste below.'),
          comment('You can freely mix question types in a single quiz. There is NO limit.'),
          blank(),
