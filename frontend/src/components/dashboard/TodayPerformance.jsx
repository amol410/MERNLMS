...
function WeekBlock({ weekRange, days }) {
  // Sort dates descending so newest days (Today, Yesterday) appear at the top
      ...
      <div className="glass-card p-5 mb-8 border border-white/8">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="flex items-center gap-1 text-xs text-dolphin-400 hover:text-dolphin-300 transition-colors font-medium cursor-pointer"
          >
      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-2.5">
          <button
            ...
            title="Back to Today's Performance"
          >
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Week-by-week overview of your learning activities</p>
          </div>
        </div>
      </div>
        ...
        {weeks.length === 0 && weekLoading ? (
          ...
          <>
            ...
            {hasMore && (
              <div className="pt-2 pb-1 text-center">
                <button
                  ...
                  className="btn-secondary text-sm px-5 py-2 flex items-center gap-2 mx-auto disabled:opacity-50 cursor-pointer"
                >
                  {weekLoading ? (
                    <>
            ...
            {!hasMore && weeks.length > 0 && (
              <p className="text-center text-gray-600 text-xs py-4">You've reached the beginning of your history 🎉</p>
            )}
          </>
        )}
      </div>
